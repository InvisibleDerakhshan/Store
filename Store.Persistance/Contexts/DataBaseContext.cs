...
namespace Bugeto_Store.Persistance.Contexts
{
    public class DataBaseContext : DbContext, IDataBaseContext
    {
        ...
        public DbSet<HomePagesImages> HomePagesImages { get; set; }
        ...
        private void ApplyQueryFilter(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HomePagesImages>().HasQueryFilter(p => !p.IsRemoved);
